...
namespace AzmanSys
{
    public partial class BookingsForm : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            if (mysqlConn.connOpen() == true)
            {
                mysqlConn.insertBooking(tbCustomerID.Text, tbBookingID.Text, tbFlightID.Text, dtBookingDateTime.Text, tbBookingTotalCost.Text);
                dataGridView1.DataSource = mysqlConn.qry("SELECT * FROM tblBooking").Tables[0];
        ...
        private void DtBookingDateTime_ValueChanged(object sender, EventArgs e)
        {
